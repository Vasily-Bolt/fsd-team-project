    ...
    //БОЛТУНОВ Меняем сокращения месяцев в moment.js (используя официальное API), чтобы убрать точки
    ...
    $.dateRangePickerLanguages = {
        ...
        "ru": //default language: Russian - БОЛТУНОВ! Теперь русский
        {
            "selected": "Selected:",
            "day": "День",
            "days": "Дней",
    ...
    $.fn.dateRangePicker = function(opt) {
        ...
        opt = $.extend(true, {
            ...
            setValue: function(s) {
                if (!$(this).is(':disabled') && s != $(this).val()) { //БОЛТУНОВ - убрал в начале условия !$(this).attr('readonly') && 
                    $(this).val(s);
                }
            },
            startDate: false,
